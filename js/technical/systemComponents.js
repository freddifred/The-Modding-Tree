var systemComponents = {
	...
	'overlay-head': {
		...
		<h2  class="overlayThing" id="points">{{player.display()}}</h2>
    ...
    'info-tab': {
		...
		<a class="link" href="https://discord.gg/jHeqgdM" target="_blank" v-bind:style="{'font-size': '16px'}">EoD discord server where btt originated</a><br>
		<a class="link" href="https://discord.gg/X9VyN42" target="_blank" v-bind:style="{'font-size': '16px'}">Server for other elemental games. I also once in a blue moon give a development update here</a><br>
		<br><br>
